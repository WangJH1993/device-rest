...
public class ProfileStore {
  ...
  // profile
  // object key
  private Map<String, Map<String, RestObject>> objects = new HashMap<>();

  public Map<String, Map<String, RestObject>> getObjects() {
    return objects;
  }
  ...
  public void addDevice(Device device) {
    ...
    Map<String, RestObject> deviceObjects = new HashMap<>();
    for (DeviceObject object: device.getProfile().getDeviceResources()) {
      RestObject RestObject = new RestObject(object);

      PropertyValue value = object.getProperties().getValue();

      deviceObjects.put(object.getName(), RestObject);
